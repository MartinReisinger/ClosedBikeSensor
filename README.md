...
An iOS app for measuring passing distances while cycling using your iPhone's LiDAR sensor. Inspired by the OpenBikeSensor project, this app leverages the built-in LiDAR capabilities of modern iPhones for a simpler, hardware-integrated solution.
